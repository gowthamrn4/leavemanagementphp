...
$select=mysql_query("select * from letter where class='Cs1ndYear'");
   ...
   for($i=0;$i<$view;$i++)
   ?>
   <li class="active"><a style="color:#666666" href="1sty.php">  <span data-toggle="tooltip" title="3 New Messages"  style="background-color:#00FFCC" class="badge bg-green"><?php echo $view;?> </span>
1st Year Leave Letter</a></li>
...
<div class="panel panel-info">
   <div class="panel-heading">
      <h3 class="panel-title">1st Year Leave Letter</h3>
   </div>
...
<table width="571" height="100" border="2" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="200" align="center">Sub</td>

    <td width="171" align="center">Time</td>
    <td width="134" align="center">ACTION</td>
  </tr></div>
 <?PHP
$select=mysql_query("select * from letter where class='Cs1ndYear'");
$view=mysql_num_rows($select);
 ...
 <tr>
    ...
    <td align="center"><?php echo mysql_result($select,$i,"sub");?></td>
