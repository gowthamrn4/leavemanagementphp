...
<ul class="nav nav-tabs">
 ...
 <?php
   ...
   <li class="active"><a style="color:#666666" href="oldl.php"><span data-toggle="tooltip" title="3 New Messages"  style="background-color:#00FF66" class="badge bg-green"><?php echo $view;?> </span>Old Letter</a></li>
    ...
    <?php
$select=mysql_query("select * from letter where class='Cs1ndYear'");
   $view=mysql_num_rows($select);
   $view1=$view+$count+1;
   for($i=0;$i<$view;$i++)
   ?>
...
$select=mysql_query("select * from letter where class='Cs2ndYear'");
   ...
   <?php
$select=mysql_query("select * from letter where class='Cs3rdYear'");
   $view=mysql_num_rows($select);
   $view1=$view+$count+1;
   for($i=0;$i<$view;$i++)
...
<form id="form3" name="form3" method="post" action="">
      ...
      <input type="submit" name="online" id="button" value="Submit" />
</form>
...
$insert=mysql_query("insert into admin(username,password,name,class,image)values('$username','$password','$name','$class','$second')");
}
if($insert)
{
?>              <div class="col-md-3">
...
{
?>
	     <div class="alert alert-danger" ><a href="#" class="close" data-dismiss="alert" aria-label="close">x</a> <p>Add New Admin..........</p></div></div>
<?php
}
?>
            <div class="col-md-3">
...
<li class="list-group-item">
  <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data">
      <input type="text" name="username" id="textfield" placeholder="User Name" required  class="form-control"/>
