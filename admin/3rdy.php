...
$select=mysql_query("select * from letter where class='Cs3rdYear'");
   ...
   for($i=0;$i<$view;$i++)
   ?>
      <li class="active"><a style="color:#666666" href="3rdy.php">    <span data-toggle="tooltip" title="3 New Messages"  style="background-color:#0066CC" class="badge bg-green"><?php echo $view;?> </span>
3rd Year Leave Letter</a></li>
...
<table width="571" height="100" border="2" cellpadding="0" cellspacing="0">
  <tr>
    <td width="54" height="45" align="center">No</td>
        <td width="54" height="45" align="center">Name</td>
